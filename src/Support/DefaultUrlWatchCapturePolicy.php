...
final class DefaultUrlWatchCapturePolicy implements UrlWatchCapturePolicyInterface
{
    ...
    public function shouldCapture(Request $request, ?Throwable $throwable = null, ?Response $response = null): bool
    {
        ...
        if (! (bool) config('url-watcher.enabled', true) || ! (bool) $settings->capture_enabled) {
            return false;
        }
